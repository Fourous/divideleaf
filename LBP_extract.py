...
# 1：原始算法:lbp_basic
# 2：等价模式:lbp_uniform
# 3：旋转不变模式:lbp_resoleve
# 4：旋转不变等价模式:lbp_resolve_uniform
#     """
...
#     resolve_uniform_array = lbp.lbp_revolve_uniform(image_array)
#     print("原始LBP", basic_array.shape)
#     print("旋转不变LBP", revolve_array.shape)
#     print("等价模式LBP", uniform_array.shape)
#     print("旋转不变等价模式LBP", resolve_uniform_array.shape)
#
